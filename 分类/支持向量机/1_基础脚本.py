...
def execute(conn, inputs, params, outputs, reportFileName):
	...
	model = SVC(C = float(params['C']), kernel = params['kernel'],degree=int(params['degree']),gamma=params['gamma'],probability = True)
	...
	report.h1('SVM算法')
	model_params={}
	model_params['核函数']=params['C']
	model_params['罚项系数']=params['kernel']
	model_params['核系数']=params['degree']
	model_params['多项式核函数的次数']=params['gamma']
	...
	model_params['intercept_']=np.around(model.intercept_,decimals=2)
